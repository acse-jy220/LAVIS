...
pretrained_config = pretrained_config.from_pretrained("/mnt/d/QFormer_origin/config.json")

state_dict = torch.load("/mnt/d/QFormer_origin/self_Qformer_state_dict_init.pth", map_location="cpu")
...
# @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@ test cases begin @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
# 1)
query_tokens = torch.load("/mnt/d/QFormer_origin/query_tokens1.pth", map_location="cpu")
image_embeds = torch.load("/mnt/d/QFormer_origin/image_embeds1.pth", map_location="cpu")
image_atts = torch.load("/mnt/d/QFormer_origin/image_atts1.pth", map_location="cpu")
...
query_output_real = torch.load("/mnt/d/QFormer_origin/query_output1.pth", map_location="cpu")
...
# 2)
input_ids = torch.load("/mnt/d/QFormer_origin/input_ids.pth")
attention_mask = torch.load("/mnt/d/QFormer_origin/attention_mask.pth")
...
text_output_real = torch.load("/mnt/d/QFormer_origin/text_output.pth")

ModelOutputCompare(text_output, text_output_real)    
SaveOutput(text_output, "text_output")

# 3)
# text_ids_all = torch.load("/mnt/d/QFormer_origin/text_ids_all.pth")
# query_tokens_itm = torch.load("/mnt/d/QFormer_origin/query_tokens_itm.pth")
# attention_mask_all = torch.load("/mnt/d/QFormer_origin/attention_mask_all.pth")
# image_embeds_all = torch.load("/mnt/d/QFormer_origin/image_embeds_all.pth")
# image_atts_all = torch.load("/mnt/d/QFormer_origin/image_atts_all.pth")
...
#     return_dict=True,
# )
# output_itm_real = torch.load("/mnt/d/QFormer_origin/output_itm.pth")

# ModelOutputCompare(output_itm, output_itm_real)    
# SaveOutput(output_itm, "output_itm")

# 4)
decoder_input_ids = torch.load("/mnt/d/QFormer_origin/decoder_input_ids.pth")
attention_mask = torch.load("/mnt/d/QFormer_origin/attention_mask_lm.pth")
past_key_values = torch.load("/mnt/d/QFormer_origin/past_key_values_lm.pth")
labels = torch.load("/mnt/d/QFormer_origin/labels_lm.pth")
lm_output = qFormer(
    decoder_input_ids,
...
lm_output_real = torch.load("/mnt/d/QFormer_origin/lm_output.pth")
